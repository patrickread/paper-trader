...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://yt65m7uv1k.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.transactionsUserIdGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['userId'], ['body']);
        
        var transactionsUserIdGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/transactions/{userId}').expand(apiGateway.core.utils.parseParametersToObject(params, ['userId'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(transactionsUserIdGetRequest, authType, additionalParams, config.apiKey);
    };
